# Approach 1 — final fitted RViz OctoMap evidence
...
Each mode contains a real RViz build video, fitted isometric/top/side screenshots, a real RViz orbit video, native `.bt` and `.ot` maps, parameters and the RViz configs used to reopen the result.
